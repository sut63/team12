...
func Purpose(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func PurposeEQ(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPurpose), v))
	})
}
...
func PurposeNEQ(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func PurposeIn(vs ...string) predicate.Purpose {
...
func PurposeNotIn(vs ...string) predicate.Purpose {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PurposeGT(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func PurposeGTE(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func PurposeLT(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func PurposeLTE(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func PurposeContains(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func PurposeHasPrefix(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func PurposeHasSuffix(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func PurposeEqualFold(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func PurposeContainsFold(v string) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func HasRoomuses() predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
...
func HasRoomusesWith(preds ...predicate.Roomuse) predicate.Purpose {
	return predicate.Purpose(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
